...
import { FilterItem, useCollection } from "@melony/core";
import { convertFieldsToFilterTokens } from "../lib/transforms";
...
export function AdvancedFilter() {
	...
	const filterTokens = convertFieldsToFilterTokens(schema);
